...
- [x] **F3 · The kaam list opens from the keyboard.** K opens and folds it (the chip shows "K"); it starts open the first time it appears; a phone taps it as before.
- [x] **F4 · A drip set installs itself.** Buying one installs it on the field you're standing in, or else your first field without drip, and says which; the Your land tab still moves the spare ones.
- [x] **F5 · People you can talk to.** No neighbour stands in a shop doorway (Tulsa aaji was at the bank door); E and the hint go to whoever is nearest, a neighbour or a stall; the neighbours by the well, the mandir and the banyan say Ram Ram.
- [x] **F6 · Up the tanki.** A proper ladder outside the bowl, with a safety cage and a landing; E at its foot climbs up, you sit on the rim looking over the tanda, and moving climbs back down.
- [x] **F7 · Sit with your friends.** E by the fire sits you in the circle (the chai and +1 once a night); moving stands you up; the hint changes once you're sitting and once tonight's visit is done.
- [x] **F8 · Offerings stop at the count.** Offering and delivery buttons show what's still needed and become "Given ✓" once the objective is met; the rules refuse to take more than is asked (Sitabai's 20, the mandir's 10 and 10); "Join the gathering" says ✓ once joined.
...
- 2026-09-25 · F3 the kaam list opens from the keyboard · K opens and folds it (a K key cap on its header; K is in the help picture and list); it starts open the first time and remembers your choice; a tap still toggles it on a phone. Verified: tsc, scripts/fix/f3.js (starts open, K folds and saves "0", K opens), screenshots looked at.
- 2026-09-25 · F4 a drip set installs itself · Buying one at Sitabai's installs it at once on the field of yours you were last in (else your first field without drip) and says which; if every field has drip it waits in your things with a note. A set bought earlier and never installed (a play-tester's friend) goes in when you enter the village. Verified: tsc, scripts/fix/f4.js (bought → installed on Aamrai, planted cell watered for good, server "saved"), and the spare-set path (inv 1 → 0, drip [9], server saved).
- 2026-09-25 · F5 people you can talk to · Tulsa aaji stood in the bank's doorway (her spot was "the house door nearest south of the chowk", and the bank is a house): shop doors are now left out. Joshi saheb stood inside the bank's wall; he's beside the door now. The sahukar's counter was 6 m from him, by the well; it's in front of him. E and the hint go to whoever is nearest, a neighbour with kaam (within reach) or a stall; the four neighbours at the well, the mandir and the banyan have names and say Ram Ram (a line a day, translated prompt). Verified: tsc, scripts/fix/f5.js (bank door → bank; well → "Say Ram Ram to Gangubai" and her card; sahukar counter in front of him), screenshots looked at.
- 2026-09-25 · F6 up the tanki · The old ladder stood 2.8 m out, inside the 3.4 m bowl, and went nowhere. The new one is on the village side, 3.6 m out: rails and rungs every 30 cm from the plinth to above the roof, braces to a column, and a safety cage of hoops from head height. E at its foot ("Climb the tanki") climbs you up in a few seconds; you sit inside the railing looking west over the tanda; moving climbs you back down to the foot. A seated state (no walking, no crowd pushing, the sit pose held) shared with F7. Verified: tsc, scripts/fix/f6.js (hint at the foot; climbing → sitting on the roof at y 37.4 with "Move to climb down"; W → climbing down → standing at the foot), screenshots looked at (foot, mid-climb, the roof view, the ladder from outside).
- 2026-09-25 · F7 sit with your friends · E by the fire sits you in the gap between two friends, facing the fire (the sit pose, no walking); the first time each night it's the story card with the +1 reputation, after that just "More chai, more stories." Moving stands you up. The hint reads "Move to stand up · tonight's chai ✓" while seated and "Sit by the fire again · tonight's chai ✓" once the night's visit is done. Verified: tsc, scripts/fix/f7.js (card once; seated 1.3 m from the fire in the sit pose; W stands up; E again sits without a card), screenshot looked at.
- 2026-09-25 · F8 offerings stop at the count · The rules know what each mission asks (Sitabai's 20 jowar, the mandir's 10 jowar and 10 onions): they take no more than what's left and refuse once it's given, so extra produce stays in your sack. The mandir shows "n of 10" and turns each button to a disabled "Offered ✓"; "Join the gathering" reads "You joined the gathering ✓"; Sitabai's order takes part-deliveries and ends "Delivered ✓". Verified: 108 vitest (new: 25 offered → 10 taken, a second offer refused, 6 then 10 onions → 4 taken), tsc, scripts/fix/f8.js with grown produce (144/22 left, both "Offered ✓" disabled), screenshot looked at.
