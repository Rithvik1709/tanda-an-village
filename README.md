...
A cinematic farming game set in a Maharashtra village. Farm black soil, water your jowar, onions
...
1. `npx vercel login`
2. `npx vercel link`: create the project `bailgaadi`.
...
6. Domains → add `bailgaadi.gajananrathod.in`, then at your DNS provider add a `CNAME` from `bailgaadi`
