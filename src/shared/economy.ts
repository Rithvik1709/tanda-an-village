...
export const SHOP: ShopItem[] = [
  ...
  { id: "bigcan", name: "Brass watering can", price: 450, note: "holds 32 waterings instead of 16", max: 1 },
  { id: "plough", name: "Wooden plough (nangar)", price: 900, note: "with your bulls: Shift + right click with the hoe tills a row of 8", max: 1 },
  ...
  { id: "gotha", name: "Gotha — a cattle shed behind your house", price: 1500, note: "tie your bulls under a roof with a trough: they get hungry half as fast", max: 1 },
