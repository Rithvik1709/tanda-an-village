...
const D: Record<string, [string, string]> = {
  ...
  "E or Enter to continue": ["E किंवा Enter दाबून पुढे", "E या Enter दबाकर आगे"],
  "Say Ram Ram to {name}": ["{name} यांना राम राम म्हणा", "{name} से राम राम कहें"],
  "Up the tanki ladder… hold on tight!": ["टाकीच्या शिडीवर… घट्ट धरा!", "टंकी की सीढ़ी पर… कसकर पकड़ें!"],
  "The whole tanda below you. Move to climb down.": ["खाली संपूर्ण तांडा. खाली उतरण्यासाठी हला.", "नीचे पूरा तांडा. नीचे उतरने के लिए हिलें."],
  "Move to climb down": ["खाली उतरण्यासाठी हला", "नीचे उतरने के लिए हिलें"],
  "Move to stand up": ["उठण्यासाठी हला", "उठने के लिए हिलें"],
  "· tonight's chai ✓": ["· आजचा चहा ✓", "· आज की चाय ✓"],
  "Sit by the fire again": ["पुन्हा शेकोटीजवळ बसा", "फिर से अलाव के पास बैठें"],
  "Climb the tanki": ["टाकीवर चढा", "टंकी पर चढ़ें"],
  "More chai, more stories.": ["आणखी चहा, आणखी गोष्टी.", "और चाय, और किस्से."],
  "Ram Ram!": ["राम राम!", "राम राम!"],
  "Ram Ram": ["राम राम", "राम राम"],
  "Press 1–{n} to choose": ["निवडण्यासाठी 1–{n} दाबा", "चुनने के लिए 1–{n} दबाएँ"],
